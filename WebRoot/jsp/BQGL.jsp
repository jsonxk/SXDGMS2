...
<!-- WRAPPER -->
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li class="rcgl">
							<a href="#subPages5" data-toggle="collapse" class="active"><i class="lnr lnr-file-empty"></i> <span></span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
	...
	<script type="text/javascript">
		function initIndex(){
			$(".rcglchild .5rcgl0 a").addClass("active");
		}
	</script>
